...
public:
	...
	virtual Demond_Deposit* Clone()
	{
		return new Demond_Deposit(*this);
	}
	virtual const char* getType() const
	{
		return "Demond_Deposit";
	}
	...
	virtual void Write(ostream& file)
	{
		...
		file << Data_creat << endl;
		file << Interest_rate << endl;
		file << Sum << endl;
		file << Data_last_interest << endl;
	}
	...
	virtual void read(ifstream& file)
	{
		...
		file >> Interest_rate;
		file >> Sum;
		file >> Data_last_interest;
	}
	friend ostream& operator<<(ostream& out, Demond_Deposit& obj)
	{
		if (&out == &cout)
			obj.Print();
		else
